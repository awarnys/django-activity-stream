...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('actstream_follow', 'object_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Action.action_object_object_id'
        db.alter_column('actstream_action', 'action_object_object_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Action.actor_object_id'
        db.alter_column('actstream_action', 'actor_object_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Action.target_object_id'
        db.alter_column('actstream_action', 'target_object_id', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        'actstream.action': {
            ...
            'action_object_object_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'actor_content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'actor'", 'to': "orm['contenttypes.ContentType']"}),
            'actor_object_id': ('django.db.models.fields.IntegerField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'target_content_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'target'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'target_object_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
